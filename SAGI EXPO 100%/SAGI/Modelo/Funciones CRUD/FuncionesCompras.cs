...
{
    class FuncionesCompras
    {
        public static DataTable TerrenosPorPrecio(ConstructorCompras che)
        {
            string query = "SELECT * FROM terreno WHERE precio =<'{0}',departamento='{1}',municipio='{2}'";
