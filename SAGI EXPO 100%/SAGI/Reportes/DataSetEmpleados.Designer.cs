...
namespace WindowsFormsApplication1.Reportes {
    ...
    public partial class DataSetEmpleados : global::System.Data.DataSet {
        ...
        public partial class DataTableDataTable : global::System.Data.TypedTableBase<DataTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTableRow AddDataTableRow(string TipoUsuario, string Nombre, string Apellido, System.DateTime Fecha_Nacimiento, string Correo, string DIreccion, string Profesion, string Usuario, string Empresa) {
        ...
        public partial class DataTableRow : global::System.Data.DataRow {
            ...
            public string TipoUsuario {
                get {
                    try {
                        return ((string)(this[this.tableDataTable.TipoUsuarioColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'TipoUsuario\' de la tabla \'DataTable\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable.TipoUsuarioColumn] = value;
                }
            }
            ...
            public System.DateTime Fecha_Nacimiento {
                get {
                    return ((global::System.DateTime)(this[this.tableDataTable.Fecha_NacimientoColumn]));
                }
                set {
                    this[this.tableDataTable.Fecha_NacimientoColumn] = value;
                }
            }
            ...
            public string Profesion {
                get {
                    try {
                        return ((string)(this[this.tableDataTable.ProfesionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Profesion\' de la tabla \'DataTable\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable.ProfesionColumn] = value;
                }
            }
            ...
            public bool IsTipoUsuarioNull() {
                return this.IsNull(this.tableDataTable.TipoUsuarioColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetTipoUsuarioNull() {
                this[this.tableDataTable.TipoUsuarioColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsProfesionNull() {
                return this.IsNull(this.tableDataTable.ProfesionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetProfesionNull() {
                this[this.tableDataTable.ProfesionColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApplication1.Reportes.DataSetEmpleadosTableAdapters {
    ...
    public partial class DataTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        tipo_usuario AS TipoUsuario, empleados.nombre_empl AS Nombre, empleados.apellido_empl AS Apellido, empleados.nacimiento_empl AS Fecha_Nacimiento, empleados.correo_empl AS Correo, 
...
WHERE        empleados.id_empresa = empresa.id_empresa AND (tipoUsuario.id_tipoUsuario = empleados.tipoUsuario) AND (empleados.tipoUsuario <> 1)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.Odbc.OdbcCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        tipo_usuario AS TipoUsuario, empleados.nombre_empl AS Nombre, empleados.apellido_empl AS Apellido, empleados.nacimiento_empl AS Fecha_Nacimiento, empleados.correo_empl AS Correo, 
                         empleados.direccion_empl AS DIreccion, empleados.profesion AS Profesion, empleados.usuario AS Usuario, empresa.empresa AS Empresa
FROM            empleados, empresa, tipoUsuario
WHERE        empleados.id_empresa = empresa.id_empresa AND (tipoUsuario.id_tipoUsuario = empleados.tipoUsuario) AND (empleados.tipoUsuario = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("tipoUsuario", global::System.Data.Odbc.OdbcType.Int, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "tipoUsuario", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int DataSetEmpleados(DataSetEmpleados.DataTableDataTable dataTable) {
        ...
        public virtual DataSetEmpleados.DataTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetEmpleados.DataTableDataTable dataTable = new DataSetEmpleados.DataTableDataTable();
        ...
        public virtual int BusquedaParametrizadaEmpleados(DataSetEmpleados.DataTableDataTable dataTable, int tipoUsuario) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(tipoUsuario));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual DataSetEmpleados.DataTableDataTable GetDataBy(int tipoUsuario) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(tipoUsuario));
            DataSetEmpleados.DataTableDataTable dataTable = new DataSetEmpleados.DataTableDataTable();
            this.Adapter.Fill(dataTable);
