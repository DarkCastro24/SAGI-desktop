...
{
    public partial class historialFactura_Terreno : Form
    {
        ...
        public historialFactura_Terreno()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = facturacion_terreno.BusquedaFiltrada(che);
        }
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("¿Seguro de eliminar factura?", "Mensaje de advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                {
                    ...
                    dataGridView1.DataSource = facturacion_terreno.mostrar();
                }
            }
            catch (Exception)
            {
        ...
        {
            dataGridView1.DataSource = facturacion_terreno.Historial();
        }

        private void historialFactura_Terreno_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = facturacion_terreno.Historial();
        }
