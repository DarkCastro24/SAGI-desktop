...
{
    public partial class historialFactura_Casa : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = facturacion_casa.BusquedaFiltrada(che);
        }

        private void historialFactura_Casa_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = facturacion_casa.Historial();
        }
